...
fn main() {
    let mut a = ModInt998244353::new(read::<usize>());
    let mut b = ModInt998244353::new(read::<usize>());
    let mut c = ModInt998244353::new(read::<usize>());
    println!("{}", (a * (a + 1)) / 2 * (b * (b + 1)) / 2 * (c * (c + 1)) / 2);
}
